...
class LibraryFunctionsTests(unittest.TestCase):
    ...
    def test_generate_major_scales(self):
        ...
        self.assertEqual(should_be, scales.generate_scale('major', start))

    def test_generate_chromatic_scales(self):
        start = 'C5'
        should_be = ['C5', 'C#5', 'D5', 'D#5', 'E5', 'F5', 'F#5', 'G5', 'G#5', 'A5', 'A#5', 'B5']
        self.assertEqual(should_be, scales.generate_scale('chromatic', start))

    def test_generate_major_pentatonic_scales(self):
        start = 'C5'
        should_be = ['C5', 'D5', 'E5', 'G5', 'A5']
        self.assertEqual(should_be, scales.generate_scale('major_pentatonic', start))

    def test_generate_minor_pentatonic_scales(self):
        start = 'A5'
        should_be = ['A5', 'C6', 'D6', 'E6', 'G6']
        self.assertEqual(should_be, scales.generate_scale('minor_pentatonic', start))

    def test_generate_dorian_mode(self):
        start = 'D5'
        should_be = ['D5', 'E5', 'F5', 'G5', 'A5', 'B5', 'C6', 'D6']
        self.assertEqual(should_be, scales.generate_scale('major', start, mode=2))

    def test_generate_phrygian_mode(self):
        start = 'E5'
        should_be = ['E5', 'F5', 'G5', 'A5', 'B5', 'C6', 'D6', 'E6']
        self.assertEqual(should_be, scales.generate_scale('major', start, mode=3))

    def test_generate_lydian_mode(self):
        start = 'C5'
        should_be = ['C5', 'D5', 'E5', 'F#5', 'G5', 'A5', 'B5', 'C6']
        self.assertEqual(should_be, scales.generate_scale('major', start, mode=4))

    def test_generate_mixolydian_mode(self):
        start = 'C5'
        should_be = ['C5', 'D5', 'E5', 'F5', 'G5', 'A5', 'A#5', 'C6']
        self.assertEqual(should_be, scales.generate_scale('major', start, mode=5))

    def test_generate_dorian_flat_nine(self):
        start = 'D5'
        should_be = ['D5', 'D#5', 'F5', 'G5', 'A5', 'B5', 'C6', 'D6']
        self.assertEqual(should_be, scales.generate_scale('melodic_minor', start, mode=2))

    def test_generate_lydian_augmented(self):
        start = 'C5'
        should_be = ['C5', 'D5', 'E5', 'F#5', 'G#5', 'A5', 'B5', 'C6']
        self.assertEqual(should_be, scales.generate_scale('melodic_minor', start, mode=3))

    def test_generate_lydian_dominant(self):
        start = 'C5'
        should_be = ['C5', 'D5', 'E5', 'F#5', 'G5', 'A5', 'A#5', 'C6']
        self.assertEqual(should_be, scales.generate_scale('melodic_minor', start, mode=4))

    def test_generate_major_triad(self):
        start = 'C5'
        should_be = ['C5', 'E5', 'G5']
        self.assertEqual(should_be, chords.generate_chord('maj', start))

    def test_generate_min_triad(self):
        start = 'C5'
        should_be = ['C5', 'D#5', 'G5']
        self.assertEqual(should_be, chords.generate_chord('min', start))

    def test_generate_maj_first_inversion(self):
        start = 'C5'
        should_be = ['E5', 'G5', 'C5']
        self.assertEqual(should_be, chords.generate_chord('maj', start, inversion=1))

    def test_generate_maj_second_inversion(self):
        start = 'C5'
        should_be = ['G5', 'C5', 'E5']
        self.assertEqual(should_be, chords.generate_chord('maj', start, inversion=2))

    def test_generate_maj_seven(self):
        start = 'C5'
        should_be = ['C5', 'E5', 'G5', 'B5']
        self.assertEqual(should_be, chords.generate_chord('maj7', start))

    def test_generate_aug(self):
        start = 'C5'
        should_be = ['C5', 'E5', 'G#5']
        self.assertEqual(should_be, chords.generate_chord('aug', start))

    def test_generate_dim(self):
        start = 'C5'
        should_be = ['C5', 'D#5', 'F#5']
        self.assertEqual(should_be, chords.generate_chord('dim', start))

    def test_generate_seven(self):
        start = 'C5'
        should_be = ['C5', 'E5', 'G5', 'A#5']
        self.assertEqual(should_be, chords.generate_chord('7', start))
